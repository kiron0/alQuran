...
export default function Developer() {
          ...
          document.title = `ডেভেলপার | Al Quran - আল কোরআন `;
                                        ...
                                        <div className='card w-full md:w-2/3 lg:w-1/3 md:glass'>
                                                  <div className='card-body'>
                                                            <div className='pb-6 hidden md:flex'>
                                                                      <button onClick={() => navigate("/")} className="flex justify-center items-center gap-1 glass py-2 px-5 mx-auto rounded-xl text-black text-md"><i className="bx bx-arrow-back text-lg"></i>Back</button>
                                                            </div>
                                                            ...
                                                            <Fade top duration={3000} distance="40px">
                                                                      <div className={`flex flex-col justify-center items-center pt-7 select-none text-black`}>
                                                                                <Fade top duration={3000} distance="40px">
                                                                                          <h2 className="text-2xl md:text-3xl font-bold flex items-center gap-1">Toufiq Hasan Kiron
                                                                                                    <svg
                                                                                                              width="25"
                                                                                                              height="25"
                                                                                                              viewBox="0 0 48 48"
                                                                                ...
                                                                                <Fade top duration={3000} distance="40px">
                                                                                          <p className='text-sm md:text-lg font-semibold'>MERN Stack Developer</p>
                                                                                          <p className='text-xs md:text-sm font-semibold pb-3'>Hellwet Software, India</p>
                                                                                </Fade>
                                                                                <Fade top duration={3000} distance="40px">
